...
public class GoogleQuery2 {           //找關鍵字
	...
	public GoogleQuery2(String searchKeyword) {			//原本是searchKeyword
		this.searchKeyword= searchKeyword;
		String a ="梗圖";
		this.url= "https://www.google.com/search?q="+ searchKeyword+ a +"&oe=utf8&num=5";
